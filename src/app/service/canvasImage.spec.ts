...
fdescribe('xrayImageService', () => {
  let xrayService: xrayImageService;
  // const httpSpy = jasmine.createSpyObj('HttpClient', ['get']);
  // const endpointSpy = jasmine.createSpyObj('ApiEndPointService', ['getPatientImage', 'getPatientInstanceId']);
  ...
  xrayService = TestBed.inject(xrayImageService);
})
afterEach(() => {
