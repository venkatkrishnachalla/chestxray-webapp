...
describe('CanvasImageComponent', () => {
  ...
  //       title: 'Draw Ellipse',
  //     };
  //     eventEmitterServiceSpy.subsVar.and.returnValue(undefined);
  //     eventEmitterServiceSpy.invokeComponentFunction.and.returnValue(
  //       of(invokeMock)
  //     );
  //     component.events = of();
  //     const fabricMock = jasmine.createSpyObj('fabric', ['Canvas']);
  //     spyOn(window as any, 'fabric').and.returnValue(fabricMock);
