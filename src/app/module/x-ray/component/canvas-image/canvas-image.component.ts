...
export class CanvasImageComponent implements OnInit {
  ...
  deleteEllipse(){
    ...
    if(activeObject){
    this.dialog.open(this.deleteObjectModel, {panelClass: 'my-class', disableClose: true})
    }
    else{
  ...
  openPathologyModal(){
    ...
    this.dialog.open(this.pathologyModal, {panelClass: 'my-class', disableClose: true });
