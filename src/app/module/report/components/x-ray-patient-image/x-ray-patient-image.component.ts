          ...
          ndarray: [
            {
              ...
              noFindings: JSON.parse(sessionStorage.getItem('noFindings')),
              poorImageQuality: JSON.parse(sessionStorage.getItem('unableToDiagnose')),
              nonChestXRay: JSON.parse(sessionStorage.getItem('unableToDiagnose')),
            },
          ],
        },
      };
