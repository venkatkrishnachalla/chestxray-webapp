export const environment = {
  ...
  patientList: window['patientList'] || 'https://chestxrayqa.southindia.cloudapp.azure.com/api-dev/v1/Patient',
    // tslint:disable-next-line: no-string-literal
  patientInstanceId: window['patientInstanceId'] || 'https://chestxrayqa.southindia.cloudapp.azure.com/api-dev/v1/Patient/XRay/',
    // tslint:disable-next-line: no-string-literal
  PatientImage: window['patientImage'] || 'https://chestxrayqa.southindia.cloudapp.azure.com/api-dev/v1/Patient/XRay/',
    // tslint:disable-next-line: no-string-literal
